#ifndef UHOBGOBLIN_RN_MACRO_PASS_COMPOSE_ARGS_HPP
#define UHOBGOBLIN_RN_MACRO_PASS_COMPOSE_ARGS_HPP

#include <Hobgoblin_include/Preprocessor.hpp>
...
#endif // !UHOBGOBLIN_RN_MACRO_PASS_COMPOSE_ARGS_HPP