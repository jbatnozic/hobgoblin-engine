...
template <>
struct fmt::formatter<jbatnozic::gridgoblin::ChunkId> : fmt::ostream_formatter {};

template <>
struct std::hash<jbatnozic::gridgoblin::ChunkId> {
    std::size_t operator()(const jbatnozic::gridgoblin::ChunkId& aChunkId) const noexcept {
