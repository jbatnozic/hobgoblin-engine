...
template <>
struct std::hash<jbatnozic::gridgoblin::SpriteId> {
    std::size_t operator()(const jbatnozic::gridgoblin::SpriteId& aSpriteId) const noexcept {
        return std::hash<jbatnozic::gridgoblin::SpriteId::WrappedType>{}(aSpriteId.get());
    }
};
