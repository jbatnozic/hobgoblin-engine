...
TEST(GriddySpatialInfoDrawingOrderTest, FourSeparateRectangles) {
...
TEST(GriddySpatialInfoDrawingOrderTest, TouchingRectanglesCycle) {
    std::array<griddy::SpatialInfo, 4> infos;
...
TEST(GriddySpatialInfoDrawingOrderTest, CircleOrbitingAnotherCircle) {
