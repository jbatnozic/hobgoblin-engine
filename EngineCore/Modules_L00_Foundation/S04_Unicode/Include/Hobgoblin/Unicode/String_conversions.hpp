...
//! TODO(move to common or sth)
#define DECLARE_TAG_TYPE(_name_) \
    constexpr struct _name_##_Tag {} _name_

DECLARE_TAG_TYPE(TO_UTF8_STD_STRING);
DECLARE_TAG_TYPE(TO_ASCII_STD_STRING);
DECLARE_TAG_TYPE(TO_STD_U8STRING);
DECLARE_TAG_TYPE(TO_STD_PATH);
DECLARE_TAG_TYPE(FROM_UTF8_STD_STRING);
DECLARE_TAG_TYPE(FROM_ASCII_STD_STRING);
DECLARE_TAG_TYPE(FROM_STD_U8STRING);
