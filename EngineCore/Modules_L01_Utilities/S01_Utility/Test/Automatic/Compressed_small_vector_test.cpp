...
static_assert(sizeof(CompressedSmallVector<std::int16_t,
                                           0,
                                           growth_strategy::Default,
                                           std::allocator<std::int16_t>>) == 8,
              "Unexpected size");
static_assert(sizeof(CompressedSmallVector<std::int16_t,
                                           1,
                                           growth_strategy::Default,
...
static_assert(sizeof(CompressedSmallVector<std::int16_t,
                                           8,
                                           growth_strategy::Default,
                                           std::allocator<std::int16_t>>) == 18,
              "Unexpected size");
static_assert(sizeof(CompressedSmallVector<std::int16_t,
                                           10,
                                           growth_strategy::Default,
                                           std::allocator<std::int16_t>>) == 22,
              "Unexpected size");
