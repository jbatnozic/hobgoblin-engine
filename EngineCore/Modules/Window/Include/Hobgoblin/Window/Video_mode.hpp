...
public:
    ...
    //!
    //! \param aModeWidth        Width in pixels
    //! \param aModeHeight       Height in pixels
    //! \param aModeBitsPerPixel Pixel depths in bits per pixel
    VideoMode(PZInteger aModeWidth, PZInteger aModeHeight, PZInteger aModeBitsPerPixel = 32);
    ...
    PZInteger width;        //!< Video mode width, in pixels
    PZInteger height;       //!< Video mode height, in pixels
    PZInteger bitsPerPixel; //!< Video mode pixel depth, in bits per pixels
};
