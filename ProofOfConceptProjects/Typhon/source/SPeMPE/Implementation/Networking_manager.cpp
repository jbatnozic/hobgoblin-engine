...
void NetworkingManager::initializeAsServer() {
    _node = hg::RN_ServerFactory::createServer(RN_Protocol::UDP, "pass123", 1, 9000, RN_NetworkingStack::Default);
...
void NetworkingManager::initializeAsClient() {
    _node = hg::RN_ClientFactory::createClient(hg::RN_Protocol::UDP, "pass123", 9000, RN_NetworkingStack::Default);
